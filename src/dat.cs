...
namespace undat_ui
{
    ...
    public class FO1File
    {
        ...
        public byte[] getData(FileStream stream) //MemoryStream
        {
        ...
        public byte[] getCompressedBytes(FileStream stream) //MemoryStream
        {
    ...
    public class FO1Dat
    {
        ...
        {
            return file.getData(fileStream); //memStream
        }
